...
local testPreparation(platform) =
  local platform_map = {
    'opensuse/leap:15': 'zypper install -y git libboost_system1_75_0-devel libboost_filesystem1_75_0-devel libboost_thread1_75_0-devel libboost_regex1_75_0-devel libboost_date_time1_75_0-devel libboost_chrono1_75_0-devel libboost_atomic1_75_0-devel cppunit-devel snappy-devel cmake',
