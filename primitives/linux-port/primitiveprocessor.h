...
{
  // [[maybe_unused]] auto& some = primitiveprocessor::globServicePrimProc->getStartupRaceFlag();
  auto n = Var("n");
  ...
  [[maybe_unused]] auto vecFilterMod = build(lowered, target, targetHost);
  [[maybe_unused]] auto vecFilterFunc = vecFilterMod->GetFunction("int642filters");
